...
import static extension de.agra.emf.modelfinder.encoding.impl.twoValuedOCL.utils.PropertyCallExpressionsExtensions.*
...
class PlaceholderReplacer extends ExpressionSwitch<Expression>
{
    ...
    override casePlaceholderExpression(PlaceholderExpression object) {
        ...
        if (object.isEmptyPlaceholder)
        {
            ...
            {
                val varExpr = instance.varExpressionFromProperty
                (
                    eStruct,
